...
export const generateMetadata = async ({
  ...
  return {
    title: page.metadataOverrides.title ?? "PixelEdgeLabs - Digital Solutions & Web Development",
    description:
      page.metadataOverrides.description ??
...
export default async function DynamicPage({
  ...
  // For the home page, show our custom sections
  if (!slugs || slugs.length === 0) {
    return (
      <>
        <PageView ingestKey="home-page" />
        <Hero
          _analyticsKey="hero"
          ...
          title="Empowering Digital Dreams with Cutting-Edge Web & App Solutions"
          subtitle="From startup ideas to enterprise-grade apps — we design, develop, and deliver excellence."
          actions={[
            { _id: "1", href: "/contact", label: "Let's Build Together", type: "primary" },
            { _id: "2", href: "/portfolio", label: "View Our Work", type: "secondary" },
          ]}
